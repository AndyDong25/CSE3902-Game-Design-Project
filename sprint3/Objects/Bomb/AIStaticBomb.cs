...
{
    public class AIStaticBomb : ISprite, ICollideable
    {
        public Game1 game;
        ...
        public AIStaticBomb(Game1 game, AIPlayer player, Vector2 pos)
        {
            this.player = player;
            this.game = game;
            texture = ItemTextureStorage.Instance.getRedBombObjectSprite();
        ...
        public AIStaticBomb(Game1 game)
        {
            this.game = game;
        }
        ...
        public void Update()
        {
            ...
            if (timer <= 0)
            {
                ...
                //game.currentMap.finishedAIBombs.Add(this);
