...
{
    public class TorpedoExplosion : ISprite
    {
        public Game1 game;
        ...
        public int sheetRow = 4;
        public int sheetColumn = 4;
        private int currentFrame = 0;
        private int totalFrames = 16;
        int randomNum = 1;
        int count = 0;

        public TorpedoExplosion(Game1 game, Vector2 pos)
        {
            this.game = game;
            this.pos = pos;
            texture = ItemTextureStorage.Instance.getTorpedoExplosionItemSprite();
